<?php 
/* Start Section */
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_controls' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_overlay_color' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_overlay_img' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_divider' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_particles' );
add_action( 'elementor/element/section/section_structure/after_section_end', 'safebyte_add_custom_section_effect_image' );
function safebyte_add_custom_section_controls( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__( 'Safebyte General Settings', 'safebyte' ),
    ...
    if ( get_post_type( get_the_ID()) === 'pxl-template' && get_post_meta( get_the_ID(), 'template_type', true ) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__( 'Header Type', 'safebyte' ),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__( 'Select Type', 'safebyte' ),
                    'sticky'      => esc_html__( 'Header Sticky', 'safebyte' ),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__( 'Column Fixed', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'safebyte' ),
                'fixed'   => esc_html__( 'Yes', 'safebyte' ),
            ),
    ...
    $element->add_control(
        'row_zoom_point',
        [
            'label'   => esc_html__( 'Zoom Point', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'description' => 'Background color displayed on scroll.',
            'options' => array(
                'false'        => esc_html__( 'No', 'safebyte' ),
                'true'   => esc_html__( 'Yes', 'safebyte' ),
            ),
            'default'      => 'false',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Overflow', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__( 'Visible', 'safebyte' ),
                'hidden'   => esc_html__( 'Hidden', 'safebyte' ),
            ),
            'default'      => 'visible', 
            'separator' => 'after',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Section Fixed Scroll', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'safebyte' ),
                'top'        => esc_html__( 'Top', 'safebyte' ),
                'bottom'   => esc_html__( 'Bottom', 'safebyte' ),
            ),
            'default'      => 'none', 
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__( 'Parallax Background Image', 'safebyte' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position', 'safebyte' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'X Position', 'safebyte' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Y Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Size', 'safebyte' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'safebyte' ),
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'safebyte' ),
            'label_on' => esc_html__( 'Custom', 'safebyte' ),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ] 
    ...
    $element->start_popover();
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left', 'safebyte' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top', 'safebyte' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Right', 'safebyte' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom', 'safebyte' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Effect', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'safebyte' ),
            'label_on' => esc_html__( 'Custom', 'safebyte' ),
            'return_value' => 'yes',
    ...
    $element->start_popover();
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateX', 'safebyte' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateY', 'safebyte' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateZ', 'safebyte' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'safebyte' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'safebyte' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'safebyte' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'safebyte' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'safebyte' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Z', 'safebyte' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale', 'safebyte' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scroll From (px)', 'safebyte' ).' (350) from offset top',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__( 'Parallax Opacity (0 - 100)', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ '%' ],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
          'label' => esc_html__( 'Full Content with space from?', 'safebyte' ),
          'type'         => \Elementor\Controls_Manager::SELECT,
                'prefix_class' => 'pxl-full-content-with-space-',
                'options'      => array(
                    'none'    => esc_html__( 'None', 'safebyte' ),
                    'start'   => esc_html__( 'Start', 'safebyte' ),
                    'end'     => esc_html__( 'End', 'safebyte' ),
                ),
                'default'      => 'none',
                'condition' => [
                    'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
                'label' => esc_html__('Container Width', 'safebyte'),
...
function safebyte_add_custom_section_overlay_color( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_color',
        [
            'label' => esc_html__( 'Safebyte Overlay Color', 'safebyte' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            ...
            'options' => array(
                'none'        => esc_html__( 'No', 'safebyte' ),
                'full'   => esc_html__( 'Full', 'safebyte' ),
                'skew'   => esc_html__( 'Skew', 'safebyte' ),
            ),
    ...
    $element->add_responsive_control(
        'overlay_left_space',
        [
            'label' => esc_html__('Overlay Left Space', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
    ...
    $element->add_responsive_control(
        'overlay_right_space',
        [
            'label' => esc_html__('Overlay Right Space', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px','%' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overlay Border Radius', 'safebyte' ),
...
function safebyte_add_custom_section_overlay_img( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_img',
        [
            'label' => esc_html__( 'Safebyte Overlay Image', 'safebyte' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_overlay_display',
        [
            'label'   => esc_html__( 'Overlay Image', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'safebyte' ),
                'image'   => esc_html__( 'Yes', 'safebyte' ),
            ),
    ...
    $element->add_control(
        'pxl_overlay_img',
        [
            'label'   => esc_html__( 'Select Image 1', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 1', 'safebyte' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'safebyte' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 1', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 1', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 1', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_control(
        'pxl_overlay_img2',
        [
            'label'   => esc_html__( 'Select Image 2', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
                'pxl_overlay_display' => ['image'],
            ],
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 2', 'safebyte' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'safebyte' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 2', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 2', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 2', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Offset Left - Image 2', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function safebyte_add_custom_section_divider( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_divider',
        [
            'label' => esc_html__( 'Safebyte Divider', 'safebyte' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'row_divider',
        [
            'label'   => esc_html__( 'Divider', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''        => esc_html__( 'None', 'safebyte' ),
                'rounded-top'   => esc_html__( 'Rounded Top', 'safebyte' ),
                'angle-top'   => esc_html__( 'Angle Top Left', 'safebyte' ),
                'angle-top-right'   => esc_html__( 'Angle Top Right', 'safebyte' ),
                'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'safebyte' ),
                'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'safebyte' ),
                'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'safebyte' ),
                'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'safebyte' ),
                'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'safebyte' ),
                'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'safebyte' ),
                'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'safebyte' ),
                'curved-top'   => esc_html__( 'Curved Top', 'safebyte' ),
                'curved-bottom'   => esc_html__( 'Curved Bottom', 'safebyte' ),
                'vertical1'   => esc_html__( 'Divider Vertical', 'safebyte' ),
                'curved-arrow'   => esc_html__( 'Curved Arrow', 'safebyte' ),
                'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'safebyte' ),
                'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'safebyte' ),
                'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'safebyte' ),
            ),
    ...
    $element->add_control(
        'divider_color_top',
        [
            'label' => esc_html__('Divider Color Top', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Divider Color Bottom', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_responsive_control(
        'divider_height',
        [
            'label' => esc_html__('Divider Height', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function safebyte_add_custom_section_particles( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_particles',
        [
            'label' => esc_html__( 'Safebyte Particles', 'safebyte' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Particles', 'safebyte' ),
    ...
    $element->add_control(
        'size_random',
        [
                'label' => esc_html__('Size Random', 'safebyte'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'false',
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'move_direction',
        [
            'label'   => esc_html__( 'Move Direction', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'safebyte' ),
                'top'        => esc_html__( 'Top', 'safebyte' ),
...
function safebyte_add_custom_section_effect_image( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_effect_image',
        [
            'label' => esc_html__( 'Safebyte Effect Images', 'safebyte' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $repeater_img->add_control(
        'image_position', 
        [
            'label' => esc_html__('Image Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'p-top-left' => 'Top Left',
    ...
    $repeater_img->add_control(
        'image_position_top', 
        [
            'label' => esc_html__('Top Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'image_position_left', 
        [
            'label' => esc_html__('Left Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Bottom Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Right Position', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Value', 'safebyte' ),
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Hover Value', 'safebyte' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '40',
            'description' => esc_html__('Enter number.', 'safebyte' ),
            'condition' => [
    ...
    $repeater_img->add_control(
        'image_display_md', 
        [
            'label' => esc_html__('Hide on Screen <= 1200px', 'safebyte'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_sm', 
        [
            'label' => esc_html__('Hide on Screen <= 767px', 'safebyte'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
...
/* Start Column */
add_action( 'elementor/element/column/layout/after_section_end', 'safebyte_add_custom_columns_controls' ); 
function safebyte_add_custom_columns_controls( \Elementor\Element_Base $element) {
    $element->start_controls_section(
        'columns_pxl',
        [
            'label' => esc_html__( 'Safebyte General Settings', 'safebyte' ),
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__( 'Column Content Align', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__( 'Default', 'safebyte' ),
                'start'           => esc_html__( 'Start', 'safebyte' ),
                'center'           => esc_html__( 'Center', 'safebyte' ),
                'end'           => esc_html__( 'End', 'safebyte' ),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__( 'Column Sticky', 'safebyte' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__( 'No', 'safebyte' ),
                'sticky' => esc_html__( 'Yes', 'safebyte' ),
            ),
            'default' => 'none',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Sticky Offset Top', 'safebyte' ),
            'type' => 'text',
            'description' => esc_html__('Enter number.', 'safebyte' ),
            'default'  => '30',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overflow Hidden', 'safebyte'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__( 'Yes', 'safebyte' ),
            'label_off' => esc_html__( 'No', 'safebyte' ),
            'return_value' => 'yes',
            'default' => 'no',
            'separator' => 'after',
...
add_action( 'elementor/element/after_add_attributes', 'safebyte_custom_el_attributes', 10, 1 );
function safebyte_custom_el_attributes($el){
...
add_filter( 'pxl-custom-section/before-render', 'safebyte_custom_section_before_render', 10, 3 );
function safebyte_custom_section_before_render($html ,$settings, $el) {
...
add_filter( 'pxl-custom-column/before-render', 'safebyte_custom_column_before_render', 10, 3 );
function safebyte_custom_column_before_render($html, $settings, $el){
