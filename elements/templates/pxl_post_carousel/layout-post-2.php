...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-post-carousel2 pxl-blog-style2" <?php if($settings['drap'] !== false) : ?>data-cursor-drap="<?php echo esc_html__('DRAG', 'safebyte'); ?>"<?php endif; ?>>
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php
                        $image_size = !empty($img_size) ? $img_size : '800x462';
                                    ...
                                    <div class="pxl-post--featured hover-imge-effect2">
                                        ...
                                        <?php if($show_author == 'true'): ?>
                                            <div class="pxl-post--author pxl-flex">
                                                <div class="pxl-author--img pxl-mr-20">
                                                    <?php pxl_print_html($author_avatar); ?>
                                                </div>
                                                <div class="pxl-author-meta">
                                                    <span><?php echo esc_html__('By Post', 'safebyte'); ?></span>
