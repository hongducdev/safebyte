...
if( count($posts) <= 0){
    echo '<div class="pxl-no-post-list">'.esc_html__( 'No Post Found', 'safebyte' ). '</div>';
    return;
}
?>
        ...
        <div class="post-list-toolbar row align-items-center justify-content-between">
            ...
            <div class="col col-sm-auto">
                <select name="orderby" class="orderby nice-select">
                    <option value="date"><?php esc_html_e('Lastest Posts','safebyte') ?></option>
                    <option value="author"><?php esc_html_e('Posts Author','safebyte') ?></option>
                    <option value="title"><?php esc_html_e('Posts Title','safebyte') ?></option>
                    <option value="rand"><?php esc_html_e('Posts Random','safebyte') ?></option>
                    <option value="comment_count"><?php esc_html_e('Comment Count','safebyte') ?></option>
                </select>
            </div>
        </div>
    <?php endif; ?>
