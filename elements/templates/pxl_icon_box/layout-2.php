        ...
        <div class="pxl-item--backdrop bg-image pxl-flipbox--back">
            <?php if ( ! empty( $settings['btn_link']['url'] ) ) {
                ...
                <div class="pxl-item--readmore">
                    <a class="btn btn-text-parallax btn-gradient-horizontal" <?php pxl_print_html($widget->get_render_attribute_string( 'btn_link' )); ?>>
                        <span class="pxl--btn-text"><?php echo esc_attr($settings['btn_text']); ?></span>
                    </a>
                </div>
            <?php } ?>
            <span class="pxl-backdrop--icon1 flaticon-iconbox text-gradient"></span>
            <span class="pxl-backdrop--icon2 flaticon-iconbox text-gradient"></span>
        </div>
    </div>
</div>