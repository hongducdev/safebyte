...
<?php if (isset($settings['text']) && !empty($settings['text']) && count($settings['text'])): ?>
    <div class="pxl-swiper-slider pxl-text-carousel2 pxl-text-layout1" <?php if ($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr__('DRAG', 'safebyte'); ?>" <?php endif; ?>>
                    ...
                    ?>
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                <span class="pxl-item--milestone el-empty">
                                    <?php echo pxl_print_html($milestone); ?>
                                </span>
