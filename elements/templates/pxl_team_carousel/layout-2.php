...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): 
    ...
    <div class="pxl-swiper-slider pxl-team pxl-team-carousel2 pxl-team-layout2" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr__('DRAG', 'safebyte'); ?>"<?php endif; ?>>
