...
<div class="pxl-counter pxl-counter4 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms" style="background-image: url(<?php echo esc_url($settings['background_overlay']['url']); ?>);">
