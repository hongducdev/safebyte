...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Video Button', 'safebyte' ),
        'icon' => 'eicon-play',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'video_icon',
                            'label' => esc_html__('Video Icon', 'safebyte' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Image Border Radius', 'safebyte' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Style', 'safebyte' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style White',
                                'style2' => 'Style Gradient 1',
                                'style3' => 'Style Gradient 2',
                            ],
                            'default' => 'style1',
                        ),
                        array(
                            'name' => 'btn_video_position',
                            'label' => esc_html__('Button Video Position', 'safebyte' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'p-center' => 'Center',
                                'p-top-left' => 'Top Left',
