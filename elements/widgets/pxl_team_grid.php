...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_team_grid',
        'title' => esc_html__('Case Team Grid', 'safebyte'),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'team',
                            'label' => esc_html__('Team', 'safebyte'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'safebyte' ),
                                    'type' => 'pxl_icons',
                                ),
                            ),
                            'title_field' => '{{{ title }}}',
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                ...
                                'body:not(.elementor-editor-active) {{WRAPPER}} .pxl-grid .pxl-item--inner' => 'margin-bottom:0px;',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pos_color',
                            'label' => esc_html__('Position Color', 'safebyte' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'pos_typography',
                            'label' => esc_html__('Position Typography', 'safebyte' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
