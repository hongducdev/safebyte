...
if (!class_exists('Safebyte_Blog')) {
    ...
    class Safebyte_Blog
    {
        ...
        public function get_tagged_in(){
            $tags_list = get_the_tag_list( '<label class="label">'.esc_attr__('Tags:', 'safebyte'). '</label>', ' ' );
            if ( $tags_list )
            {
        ...
        public function get_socials_share() { 
            ...
            $social_pinterest = safebyte()->get_theme_opt( 'social_pinterest', true );
            $social_linkedin = safebyte()->get_theme_opt( 'social_linkedin', true );
            ?>
            <div class="pxl--social">
                <label><?php echo esc_html__('Share:', 'safebyte'); ?></label>
