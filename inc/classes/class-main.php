...
if (!class_exists('Safebyte_Main')) { 
    class Safebyte_Main extends Safebyte_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Safebyte_Main();
            }
...
function safebyte() {
    return Safebyte_Main::getInstance();
}
// Install
safebyte(); 
