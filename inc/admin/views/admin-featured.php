<div class="pxl-iconbox">
	...
	<div class="pxl-iconbox-contents">
		...
		<p><?php esc_html_e( 'Smart Dashboard keeps your site up-to-date. Free for lifetime.', 'safebyte' ); ?></p>
	</div>
</div>
...
<div class="pxl-iconbox">
	...
	<div class="pxl-iconbox-contents">
		...
		<p><?php esc_html_e( 'Get access to premium and exclusive plugins for free.', 'safebyte' ); ?></p>
	</div>
</div>
...
<div class="pxl-iconbox">
	...
	<div class="pxl-iconbox-contents">
		...
		<p><?php esc_html_e( 'Get access to top-notch support.', 'safebyte' ); ?></p>
	</div>
</div>