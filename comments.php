...
<div id="comments" class="comments-area">
    ...
    $args = array(
        ...
        'title_reply'       => esc_attr__('Leave A Comment', 'herrington'),
        'title_reply_to'    => esc_attr__('Leave A Comment To ', 'herrington') . '%s',
        'cancel_reply_link' => esc_attr__('Cancel Comment', 'herrington'),
        ...
        'fields' => apply_filters(
            ...
            array(
                ...
                '<div class="row"><div class="col-12 notice-f">Your email address will not be published. Required fields are marked *</div><div class="comment-form-author col-lg-6 col-md-6 col-sm-12">' .
                    ...
                    '" size="30" placeholder="' . esc_attr__('Your Name', 'herrington') . '"/></div>',

                'email' =>
                '<div class="comment-form-email col-lg-6 col-md-6 col-sm-12">' .
                    '<input id="email" name="email" type="text" value="' . esc_attr($commenter['comment_author_email']) .
                    '" size="30" placeholder="' . esc_attr__('Email Address', 'herrington') . '"/></div>',
            )
        ),
        'comment_field' =>  '<div class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="' . esc_attr__('Your Comment...', 'herrington') . '" aria-required="true">' .
            '</textarea></div>',
    );
    comment_form($args); ?>
</div>